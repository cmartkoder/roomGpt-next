...
```bash
git clone https://github.com/cmartkoder/roomGpt-next
```
...
[![Deploy with Vercel](https://vercel.com/button)](https://vercel.com/new/clone?repository-url=https://github.com/cmartkoder/roomGPT-next&env=REPLICATE_API_KEY&project-name=room-GPT&repo-name=roomGPT)
